<?php
// Path: wp-content/plugins/wp2s/Singles/Integrations/init.php
namespace WPS2\Singles\Integrations;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_integration';
    private $slug       = 'integrate';
    private $archive    = 'integrations';
    private $singular   = 'Integration';
    private $plural     = 'Integrations';
    private $menu       = 'Integrations';
    private $icon       = 'dashicons-media-code';
