<?php
// Path: wp-content/plugins/wp2s/Singles/Modules/init.php
namespace WPS2\Singles\Modules;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_module';
    private $slug       = 'module';
    private $archive    = 'modules';
    private $singular   = 'Module';
    private $plural     = 'Modules';
    private $menu       = 'WP2 Modules';
