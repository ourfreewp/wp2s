<?php
// Path: wp-content/plugins/wp2s/Types/CharterArticles/init.php

namespace WP2S\Types\CharterArticles;

class Controller {

    private $textdomain = 'wp2s';
    private $prefix     = 'wp2s_';
    private $taxonomy   = 'wp2s_charter_article';
    private $singular   = 'Article';
    private $plural     = 'Articles';
    private $slug       = 'charter-article';
    private $post_types = [
        'wp2s_charter',
    ];
