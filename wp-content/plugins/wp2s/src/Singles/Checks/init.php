<?php
// Path: wp-content/plugins/wp2s/Singles/Checks/init.php
namespace WPS2\Singles\Checks;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_check';
    private $slug       = 'check';
    private $archive    = 'health';
    private $singular   = 'Check';
    private $plural     = 'Checks';
    private $menu       = 'Health';
    private $icon       = 'dashicons-yes-alt';
