<?php
namespace WPS2\Singles\Extensions;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_extension';
    private $slug       = 'extend';
    private $archive    = 'extensions';
    private $singular   = 'Extension';
    private $plural     = 'Extensions';
    private $menu       = 'Extensions';
