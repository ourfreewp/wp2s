<?php
namespace WPS2\Singles\Spaces;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_space';
    private $slug       = 'space';
    private $archive    = 'community';
    private $singular   = 'Space';
    private $plural     = 'Spaces';
    private $menu       = 'Community';
    private $icon       = 'dashicons-format-chat';
