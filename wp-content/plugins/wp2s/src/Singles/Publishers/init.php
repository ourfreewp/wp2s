<?php
namespace WPS2\Singles\Publishers;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_publisher';
    private $slug       = 'publisher';
    private $archive    = 'publishers';
    private $singular   = 'Publisher';
    private $plural     = 'Publishers';
    private $menu       = 'Publishers';
    private $icon       = 'dashicons-printer';
