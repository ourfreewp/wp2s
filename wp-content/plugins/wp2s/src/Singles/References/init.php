<?php
// Path: wp-content/plugins/wp2s/Singles/References/init.php
namespace WPS2\Singles\References;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_reference';
    private $slug       = 'reference';
    private $archive    = 'library';
    private $singular   = 'Reference';
    private $plural     = 'References';
