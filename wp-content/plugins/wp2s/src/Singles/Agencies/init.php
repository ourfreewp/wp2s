<?php
namespace WPS2\Singles\Agencies;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_agency';
    private $archive    = 'agencies';
    private $slug       = 'agency';
    private $singular   = 'Agency';
    private $plural     = 'Agencies';
    private $menu       = 'Agencies';
    private $icon       = 'dashicons-building';
...
$agency_controller = new Controller();
$agency_controller->extend_post_type();