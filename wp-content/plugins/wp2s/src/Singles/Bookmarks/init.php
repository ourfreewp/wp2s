<?php
namespace WPS2\Singles\Bookmarks;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_bookmark';
    private $archive    = 'bookmarks';
    private $slug       = 'bookmark';
    private $singular   = 'Bookmark';
    private $plural     = 'Bookmarks';
    private $menu       = 'Bookmarks';
    private $icon       = 'dashicons-admin-links';

    public function __construct() {
        add_action( 'init', [ $this, 'extend_post_type' ] , 40 );
    }
