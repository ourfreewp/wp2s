<?php
// Path: wp-content/plugins/wp2s/Types/init-collections.php

namespace WP2S\Types\Collections;
...
class Controller {
    ...
    private $singular   = 'Collection';
    private $plural     = 'Collections';
    private $slug       = 'collection';
    private $post_types = [];
