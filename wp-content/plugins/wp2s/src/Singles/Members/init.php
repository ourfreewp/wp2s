<?php
// Path: wp-content/plugins/wp2s/Singles/Members/init.php
namespace WPS2\Singles\Members;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_member';
    private $slug       = 'member';
    private $archive    = 'members';
    private $singular   = 'Member';
    private $plural     = 'Members';
    private $menu       = 'Members';
    private $icon       = 'dashicons-nametag';
