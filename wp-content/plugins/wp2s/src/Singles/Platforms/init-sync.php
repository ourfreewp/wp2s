<?php
// Path: wp-content/plugins/wp2s/src/Singles/Platforms/init-sync.php

namespace WP2S\Platforms\Sync;
...
class Controller
{
    ...
    private $dir = WP2S_PLUGIN_DIR . 'src/Platforms/';
    private $post_type = 'wp2s_platform';
    private $dir_identifier = 'platforms';
    private $suffix = '-platform';
