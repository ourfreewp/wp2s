<?php
// Path: wp-content/plugins/wp2s/Singles/Blocks/init-block-libraries.php

namespace WP2S\Types\BlocksLibraries;
...
class Controller {
    ...
    private $singular   = 'Block Library';
    private $plural     = 'Block Libraries';
    private $slug       = 'block-library';
    private $post_types = [];
