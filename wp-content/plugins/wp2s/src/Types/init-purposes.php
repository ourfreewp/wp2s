<?php
// Path: wp-content/plugins/wp2s/Types/Purposes/init.php

namespace WP2S\Types\Purposes;

class Controller {

    private $textdomain = 'wp2s';
    private $prefix     = 'wp2s_';
    private $taxonomy   = 'wp2s_purpose';
    private $singular   = 'Purpose';
    private $plural     = 'Purposes';
    private $slug       = 'purpose';
    private $post_types = [
        'wp2s_plugin',
        'wp2s_integration',
        'wp2s_extension',
