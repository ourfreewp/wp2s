<?php
// Path: wp-content/plugins/wp2s/Singles/Bundles/init.php
namespace WPS2\Singles\Bundles;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_bundle';
    private $slug       = 'bundle';
    private $archive    = 'bundles';
    private $singular   = 'Bundle';
    private $plural     = 'Bundles';
    private $menu       = 'Bundles';
    private $icon       = 'dashicons-products';
