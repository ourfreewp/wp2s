<?php
namespace WPS2\Singles\Blocks;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_block';
    private $slug       = 'block';
    private $archive    = 'blocks';
    private $singular   = 'Block';
    private $plural     = 'Blocks';
    private $menu       = 'Blocks';
    private $icon       = 'dashicons-block-default';
