<?php
namespace WPS2\Singles\DefinedTerms;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_defined_term';
    private $slug       = 'define';
    private $archive    = 'glossary';
    private $singular   = 'Definition';
    private $plural     = 'Definitions';
    private $menu       = 'Glossary';
