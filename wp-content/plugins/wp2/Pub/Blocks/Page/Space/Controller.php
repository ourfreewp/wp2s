<?php
// Path: wp-content/plugins/freewp-spaces/src/types/init-spaces.php
/**
 * Spaces Post Type
 *
 ...
 * Class Spaces
 *
 * Registers the "Spaces" custom post type by extending the abstract PostType class.
 */
...
class Spaces extends PostType
{
    ...
    protected function get_args()
    {
        ...
        return [
            ...
            'description'         => esc_html__('Spaces created by users.', $textdomain),
            'public'              => true,
            'hierarchical'        => false,
