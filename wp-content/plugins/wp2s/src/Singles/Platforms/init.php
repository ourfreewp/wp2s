<?php
namespace WPS2\Singles\Platforms;

class Controller {

    private $textdomain = 'wp2s';
    private $type       = 'wp2s_platform';
    private $slug       = 'use';
    private $archive    = 'stack';
    private $singular   = 'Platform';
    private $plural     = 'Platforms';
    private $menu       = 'Stack';
    ...
    // for each tax in taxonomies, add to post type
